...
if (typeIndex === -1) {
  //如果当前脚本执行环境不为在数组内，则进行转跳
  let t = +prompt(
    "当前域名无法执行脚本，输入1转跳职教云,输入2转跳智慧职教,输入3转跳资源库,其他取消转跳"
  ); //转number型
  ...
  $("body").append(
    `<script src="https://fastly.jsdelivr.net/gh/hsjzhcq/hcqHome@main/main/${
      typeIndex === 2 ? "special_" : ""
    }cont.min.js"></srcipt>`
  );
}
